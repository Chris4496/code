...
image = cv2.imread('bubbleTest6.jpg')
# cv2.imshow('test0', image)
paper, wraped = warpedPaper(image, (1080, 1920))
...
cv2.imshow("left", left_result)
right_result = correct(right, rightW, CHOICE_PER_QUESTION, ANSWER_KEY)
cv2.imshow("right", right_result)
